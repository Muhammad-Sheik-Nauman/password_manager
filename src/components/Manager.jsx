...
const Manager = () => {
    ...
    return (
        <>
            ...
            <div className=" mx-auto bg-slate-450 md:mycontainer shadow-lg w-full max-w-2xl h-full max-h-2xl">
                <div className='text-black flex flex-col p-4 justify-between'>
                    ...
                    <input className="bg-slate-100 border border-gray-300 rounded-full px-2 w-full " value={form.site} onChange={handleChange} name='site' type="text" placeholder="enter website url " />
                    <div className='flex flex-row sm:space-x-5 mt-4'>
                        <input className='bg-slate-100 border border-gray-300 rounded-full w-full px-2 ' value={form.username} onChange={handleChange} name='username' type="text" placeholder='enter username ' />
                        <div className="relative">
                            <input
                                ref={passwordRef}
                                className='bg-slate-100 border border-gray-300 rounded-full w-full px-2 pr-5'
                                value={form.password}
                            ...
                            />
                            <span className='px absolute inset-y-0 right-2 flex items-center cursor-pointer ' onClick={showPassword}>
